# Generated by Django 5.0 on 2024-01-27 19:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0002_alter_product_datetime_modified_comment'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='stars',
            field=models.CharField(choices=[('1', 'Very Bad'), ('2', 'Bad'), ('3', 'Normal'), ('4', 'Good'), ('5', 'Perfect')], max_length=10, verbose_name='What is the score?'),
        ),
    ]
